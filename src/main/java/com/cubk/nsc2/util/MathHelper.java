...
public class MathHelper
{
    ...
    private static final float radToIndex = MathUtil.roundToFloat(651.8986469044033D);
    public static final float deg2Rad = MathUtil.roundToFloat(0.017453292519943295D);
    ...
    static
    {
        ...
        {
            SIN_TABLE_FAST[j] = MathUtil.roundToFloat(Math.sin((double)j * Math.PI * 2.0D / 4096.0D));
        }
