...
public class NBTTagCompound extends NBTBase {
    private Map<String, NBTBase> tagMap = new ConcurrentHashMap<>();
    ...
    public byte[] getByteArray(String key) {
        try {
            ...
            throw new NullPointerException(this.createCrashReport(key, 7, classcastexception));
        }
    }
    ...
    public int[] getIntArray(String key) {
        try {
            ...
            throw new NullPointerException(this.createCrashReport(key, 11, classcastexception));
        }
    }
    ...
    public NBTTagCompound getCompoundTag(String key) {
        try {
            ...
            throw new NullPointerException(this.createCrashReport(key, 10, classcastexception));
        }
    }
    ...
    public NBTTagList getTagList(String key, int type) {
        try {
            ...
            throw new NullPointerException(this.createCrashReport(key, 9, classcastexception));
        }
    }
